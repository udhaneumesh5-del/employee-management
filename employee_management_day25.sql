...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2026 at 07:39 AM
...
(51, 'HR User', 'Created expense type: Travel', 'HR User', '2026-08-31 02:35:31', '2026-08-31 02:35:31', '2026-08-31 02:35:31'),
(52, 'HR User', 'Created expense type: Food', 'HR User', '2026-08-31 02:36:06', '2026-08-31 02:36:06', '2026-08-31 02:36:06'),
(53, 'Kaustubh Patil', 'Submitted reimbursement request (Food)', 'Kaustubh Patil', '2026-08-31 06:28:32', '2026-08-31 06:28:32', '2026-08-31 06:28:32'),
(54, 'Kaustubh Patil', 'Manager approved reimbursement request', 'Rohan Patil', '2026-08-31 06:34:27', '2026-08-31 06:34:27', '2026-08-31 06:34:27'),
(55, 'Kaustubh Patil', 'HR approved reimbursement request', 'HR User', '2026-08-31 06:35:51', '2026-08-31 06:35:51', '2026-08-31 06:35:51');
...
INSERT INTO `expense_types` (`id`, `name`, `code`, `description`, `is_active`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 'Travel', 'TRAVEL', 'Travel expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(4, 'Food', 'FOOD', 'Food and meal expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(5, 'Hotel', 'HOTEL', 'Hotel and accommodation expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(6, 'Fuel', 'FUEL', 'Fuel and transportation expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(7, 'Parking', 'PARKING', 'Parking expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(8, 'Toll', 'TOLL', 'Toll expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(9, 'Internet', 'INTERNET', 'Internet and broadband expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(10, 'Mobile', 'MOBILE', 'Mobile phone expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(11, 'Office Supplies', 'OFFICE_SUPPLIES', 'Office supplies and stationery', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(12, 'Printing', 'PRINTING', 'Printing and photocopy expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL),
(13, 'Other', 'OTHER', 'Other miscellaneous expenses', 1, '2026-08-31 11:29:34', '2026-08-31 11:31:05', NULL);
...
(44, '2026_08_31_060703_create_expense_types_table', 21),
(45, '2026_08_31_060741_create_reimbursement_policies_table', 21),
(46, '2026_08_31_060822_create_reimbursements_table', 21),
(47, '2026_08_31_060850_create_reimbursement_approvals_table', 21),
(48, '2026_08_31_071626_add_deleted_at_to_expense_types_table', 22),
(49, '2026_08_31_071917_add_status_to_reimbursement_policies_table', 23),
(50, '2026_08_31_072138_add_deleted_at_to_reimbursement_policies_table', 24),
(51, '2026_08_31_115223_add_policy_columns_to_reimbursements_table', 25),
(52, '2026_08_31_115620_add_missing_columns_to_reimbursements_table', 26);
...
CREATE TABLE `reimbursements` (
  ...
  `requester_role` enum('Employee','Manager','HR') NOT NULL,
  ...
  `policy_limit_at_submission` decimal(10,2) DEFAULT NULL,
  `policy_name_at_submission` varchar(255) DEFAULT NULL,
  `receipt_required_at_submission` tinyint(1) NOT NULL DEFAULT 1,
  `status` enum('draft','pending_manager','pending_hr','pending_admin','manager_approved','manager_rejected','hr_approved','hr_rejected','admin_approved','admin_rejected','approved_final','paid','cancelled') NOT NULL DEFAULT 'draft',
  `approval_flow` enum('employee_to_manager_to_hr','manager_to_hr','hr_to_admin') DEFAULT NULL,
  `current_approval_level` varchar(255) DEFAULT NULL,
  `manager_id` bigint(20) UNSIGNED DEFAULT NULL,
  `manager_approved_at` timestamp NULL DEFAULT NULL,
  `manager_remarks` text DEFAULT NULL,
  ...
  `admin_approved_at` timestamp NULL DEFAULT NULL,
  `admin_remarks` text DEFAULT NULL,
  `final_approver_id` bigint(20) UNSIGNED DEFAULT NULL,
  `final_approver_role` enum('HR','Admin') DEFAULT NULL,
  ...
  `exception_amount` decimal(10,2) DEFAULT NULL,
  `exception_reason` text DEFAULT NULL,
  `exception_approved_by` bigint(20) UNSIGNED DEFAULT NULL,
  `exception_approved_at` timestamp NULL DEFAULT NULL,
  `remarks` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `policy_limit_type_at_submission` enum('per_claim','per_day','per_month','per_year') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `reimbursements` (`id`, `requester_id`, `requester_role`, `expense_type_id`, `expense_date`, `amount`, `description`, `receipt`, `policy_id`, `policy_limit_at_submission`, `policy_name_at_submission`, `receipt_required_at_submission`, `status`, `approval_flow`, `current_approval_level`, `manager_id`, `manager_approved_at`, `manager_remarks`, `hr_id`, `hr_approved_at`, `hr_remarks`, `admin_id`, `admin_approved_at`, `admin_remarks`, `final_approver_id`, `final_approver_role`, `final_approved_at`, `paid_amount`, `payment_date`, `payment_method`, `payment_reference`, `paid_by`, `payment_remarks`, `is_exception`, `exception_amount`, `exception_reason`, `exception_approved_by`, `exception_approved_at`, `remarks`, `created_at`, `updated_at`, `deleted_at`, `policy_limit_type_at_submission`) VALUES
(1, 14, 'Employee', 4, '2026-08-28', 1000.00, 'I will go to the client office', 'reimbursements/6SJRQyVBOmASOpcjlGea3BQ6w3Rd8YojqLSKK5W5.pdf', 7, 1000.00, 'Food Policy', 1, 'approved_final', 'employee_to_manager_to_hr', 'manager', 5, '2026-08-31 06:34:27', NULL, 35, '2026-08-31 06:35:51', NULL, NULL, NULL, NULL, 35, 'HR', '2026-08-31 06:35:51', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 'offical meeting', '2026-08-31 06:28:32', '2026-08-31 06:35:51', NULL, 'per_day');
...
CREATE TABLE `reimbursement_approvals` (
  ...
  `action` enum('submitted','approved','rejected','cancelled','paid') NOT NULL,
...
INSERT INTO `reimbursement_approvals` (`id`, `reimbursement_id`, `user_id`, `role`, `approval_level`, `action`, `previous_status`, `new_status`, `remarks`, `is_final_approval`, `is_exception`, `created_at`, `updated_at`) VALUES
(1, 1, 13, 'Employee', 'manager', 'submitted', 'draft', 'pending_manager', 'offical meeting', 0, 0, '2026-08-31 06:28:32', '2026-08-31 06:28:32'),
(2, 1, 16, 'Manager', 'manager', 'approved', 'pending_manager', 'manager_approved', NULL, 0, 0, '2026-08-31 06:34:27', '2026-08-31 06:34:27'),
(3, 1, 9, 'HR', 'manager', 'approved', 'manager_approved', 'approved_final', NULL, 1, 0, '2026-08-31 06:35:51', '2026-08-31 06:35:51');

-- --------------------------------------------------------

--
-- Table structure for table `reimbursement_policies`
--
...
CREATE TABLE `reimbursement_policies` (
  ...
  `limit_type` enum('per_claim','per_day','per_month','per_year') NOT NULL DEFAULT 'per_claim',
  `max_claims` int(11) DEFAULT NULL,
  `receipt_required` tinyint(1) NOT NULL DEFAULT 1,
  `exception_allowed` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `reimbursement_policies`
--

INSERT INTO `reimbursement_policies` (`id`, `name`, `expense_type_id`, `maximum_amount`, `limit_type`, `max_claims`, `receipt_required`, `exception_allowed`, `effective_from`, `effective_to`, `description`, `status`, `is_active`, `created_by`, `updated_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(6, 'Travel Policy', 3, 5000.00, 'per_claim', NULL, 1, 1, '2026-01-01', NULL, NULL, 'Active', 1, 8, 8, '2026-08-31 11:37:29', '2026-08-31 11:37:29', NULL),
(7, 'Food Policy', 4, 1000.00, 'per_day', NULL, 1, 0, '2026-01-01', NULL, NULL, 'Active', 1, 8, 8, '2026-08-31 11:37:29', '2026-08-31 11:37:29', NULL),
(8, 'Fuel Policy', 6, 5000.00, 'per_month', NULL, 1, 0, '2026-01-01', NULL, NULL, 'Active', 1, 8, 8, '2026-08-31 11:37:29', '2026-08-31 11:37:29', NULL),
(9, 'Hotel Policy', 5, 3000.00, 'per_day', NULL, 1, 1, '2026-01-01', NULL, NULL, 'Active', 1, 8, 8, '2026-08-31 11:37:29', '2026-08-31 11:37:29', NULL),
(10, 'Internet Policy', 9, 1500.00, 'per_month', NULL, 1, 0, '2026-01-01', NULL, NULL, 'Active', 1, 8, 8, '2026-08-31 11:37:29', '2026-08-31 11:37:29', NULL);
...
(8, 'Admin User', 'admin@example.com', NULL, '$2y$12$Ap2WNdbGVVJ3IubHwWA70OYQr88S/0M/aEnmiq2Gth2y5OCSdp5/K', 'NMhXWB4ZhHP4P26SxsRkn3dmR2jpklgz56wQ8I48UQzTGA5bFNMcT7kNmV7d', '2026-08-11 04:27:02', '2026-08-11 04:27:02', 'Admin', NULL, 'Active'),
...
(18, 'Test User', 'test@example.com', '2026-08-31 01:34:55', '$2y$12$e7921swubFCNRfx2Qngk/ulNsTbKPLzgXiPjBqObn7ptM.Kjw.fVW', 'XZFZXmDJNL', '2026-08-31 01:34:57', '2026-08-31 01:34:57', 'Employee', NULL, 'Active');
...
ALTER TABLE `reimbursements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `reimbursements_expense_type_id_foreign` (`expense_type_id`),
  ADD KEY `reimbursements_policy_id_foreign` (`policy_id`),
  ADD KEY `reimbursements_manager_id_foreign` (`manager_id`),
  ADD KEY `reimbursements_hr_id_foreign` (`hr_id`),
  ADD KEY `reimbursements_admin_id_foreign` (`admin_id`),
  ADD KEY `reimbursements_final_approver_id_foreign` (`final_approver_id`),
  ADD KEY `reimbursements_paid_by_foreign` (`paid_by`),
  ADD KEY `reimbursements_exception_approved_by_foreign` (`exception_approved_by`),
  ADD KEY `reimbursements_status_index` (`status`),
  ADD KEY `reimbursements_requester_role_index` (`requester_role`),
  ADD KEY `reimbursements_requester_id_status_index` (`requester_id`,`status`);

--
-- Indexes for table `reimbursement_approvals`
--
ALTER TABLE `reimbursement_approvals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `reimbursement_approvals_reimbursement_id_foreign` (`reimbursement_id`),
  ADD KEY `reimbursement_approvals_user_id_foreign` (`user_id`);

--
-- Indexes for table `reimbursement_policies`
--
ALTER TABLE `reimbursement_policies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `reimbursement_policies_expense_type_id_foreign` (`expense_type_id`),
  ADD KEY `reimbursement_policies_created_by_foreign` (`created_by`),
  ADD KEY `reimbursement_policies_updated_by_foreign` (`updated_by`);
...
--
-- AUTO_INCREMENT for table `reimbursement_approvals`
--
ALTER TABLE `reimbursement_approvals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `reimbursement_policies`
--
ALTER TABLE `reimbursement_policies`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `reimbursements`
  ADD CONSTRAINT `reimbursements_admin_id_foreign` FOREIGN KEY (`admin_id`) REFERENCES `employees` (`id`),
  ADD CONSTRAINT `reimbursements_exception_approved_by_foreign` FOREIGN KEY (`exception_approved_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `reimbursements_expense_type_id_foreign` FOREIGN KEY (`expense_type_id`) REFERENCES `expense_types` (`id`),
  ADD CONSTRAINT `reimbursements_final_approver_id_foreign` FOREIGN KEY (`final_approver_id`) REFERENCES `employees` (`id`),
  ADD CONSTRAINT `reimbursements_hr_id_foreign` FOREIGN KEY (`hr_id`) REFERENCES `employees` (`id`),
  ADD CONSTRAINT `reimbursements_manager_id_foreign` FOREIGN KEY (`manager_id`) REFERENCES `employees` (`id`),
  ADD CONSTRAINT `reimbursements_paid_by_foreign` FOREIGN KEY (`paid_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `reimbursements_policy_id_foreign` FOREIGN KEY (`policy_id`) REFERENCES `reimbursement_policies` (`id`),
  ADD CONSTRAINT `reimbursements_requester_id_foreign` FOREIGN KEY (`requester_id`) REFERENCES `employees` (`id`);

--
-- Constraints for table `reimbursement_approvals`
--
ALTER TABLE `reimbursement_approvals`
  ADD CONSTRAINT `reimbursement_approvals_reimbursement_id_foreign` FOREIGN KEY (`reimbursement_id`) REFERENCES `reimbursements` (`id`),
  ADD CONSTRAINT `reimbursement_approvals_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `reimbursement_policies`
--
ALTER TABLE `reimbursement_policies`
  ADD CONSTRAINT `reimbursement_policies_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `reimbursement_policies_expense_type_id_foreign` FOREIGN KEY (`expense_type_id`) REFERENCES `expense_types` (`id`),
  ADD CONSTRAINT `reimbursement_policies_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`);
