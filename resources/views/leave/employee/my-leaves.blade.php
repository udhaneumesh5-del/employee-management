...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5><i class="fas fa-calendar-alt"></i> My Leave Requests</h5>
    ...
    <div class="card-body">
        <!-- Filter Form -->
        <form action="{{ route('leave.my-leaves') }}" method="GET" class="mb-3">
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <a href="{{ route('leave.my-leaves') }}" class="btn btn-secondary" style="margin-top: 30px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('leave.cancel', $leave->id) }}" class="btn btn-danger btn-sm" 
