...
@section('page-title', 'Pending Manager Approvals')

@section('content')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5><i class="fas fa-clock"></i> Pending Manager Approvals</h5>
    ...
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Approve Form -->
                                <form action="{{ route('reimbursements.manager.approve', $reimbursement->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                ...
                                <div class="modal fade" id="rejectModal{{ $reimbursement->id }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('reimbursements.manager.approve', $reimbursement->id) }}" method="POST">
                                                @csrf
        ...
        @else
            <div class="alert alert-info">
                <i class="fas fa-info-circle"></i> No pending approvals for your team.
            </div>
        @endif
    </div>
</div>
