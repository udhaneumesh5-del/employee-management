...
@section('page-title', 'Pending Admin Approvals')

@section('content')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5><i class="fas fa-clock"></i> Pending Admin Approvals (HR Requests)</h5>
    ...
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Approve Form -->
                                <form action="{{ route('reimbursements.admin.approve', $reimbursement->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                    <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Approve this HR request? This will be the final approval.')">
                                ...
                                <div class="modal fade" id="rejectModal{{ $reimbursement->id }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('reimbursements.admin.approve', $reimbursement->id) }}" method="POST">
                                                @csrf
        ...
        @else
            <div class="alert alert-info">
                <i class="fas fa-info-circle"></i> No pending HR requests for Admin approval.
            </div>
        @endif
    </div>
</div>
